    ...
    var colorPicker = function (button, type) {
        ...
        input.addEventListener("input", () => {
            ...
            if (type == "textBackColor") {
                button.querySelector("#textBackColor").style.background =
                    input.value;
        ...
        html: {
            ...
            result: ({ content }) => {
                ...
                const htmlContentElement =
                    parentElement.querySelector(".htmlContent");
                const elementContentElement =
                    parentElement.querySelector(".tex-content");
    ...
    var init = (settings) => {
        ...
        content.onkeydown = (event) => {
            if (
                ...
                setTimeout(
                    () => exec(formatBlock, `<${paragraphSeparator}>`),
                    0
                );
            }
        };
        ...
        actions.forEach((action) => {
            ...
            button.onclick = () =>
                action.result({ action, content, button }) && content.focus();
